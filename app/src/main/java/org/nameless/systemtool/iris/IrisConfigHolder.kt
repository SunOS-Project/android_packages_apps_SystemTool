...
import org.nameless.systemtool.iris.util.Constants.LOCAL_IRIS_CONFIG_PATH
import org.nameless.systemtool.iris.util.Constants.SYSTEM_IRIS_CONFIG_PATH
...
object IrisConfigHolder : IOnlineConfigurable.Stub() {
    ...
    override fun getOnlineConfigUri(): String =
            SystemProperties.get("persist.sys.nameless.uri.iris")
