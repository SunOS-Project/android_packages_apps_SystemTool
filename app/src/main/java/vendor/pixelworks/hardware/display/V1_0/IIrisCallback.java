...
public interface IIrisCallback extends IBase {
    ...
    void onFeatureChanged(int type, ArrayList<Integer> values) throws RemoteException;
    ...
    static IIrisCallback asInterface(IHwBinder binder) {
        ...
        final IIrisCallback proxy = new Proxy(binder);
        try {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                case 1:
                    ...
                    onFeatureChanged(_hidl_request.readInt32(), _hidl_request.readInt32Vector());
