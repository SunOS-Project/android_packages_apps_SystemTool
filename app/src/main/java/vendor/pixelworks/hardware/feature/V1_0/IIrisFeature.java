...
public interface IIrisFeature extends IBase {
    ...
    public interface GetFeatureCallback {
        void onValues(int result, int feature);
    }
    ...
    void getFeature(GetFeatureCallback callback) throws RemoteException;

    static IIrisFeature asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        final IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof IIrisFeature)) {
            return (IIrisFeature) iface;
        }
        final IIrisFeature proxy = new Proxy(binder);
        try {
    ...
    static IIrisFeature castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IIrisFeature getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IIrisFeature getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static IIrisFeature getService(String serviceName) throws RemoteException {
    ...
    public static final class Proxy implements IIrisFeature {
        ...
        @Override
        public void getFeature(GetFeatureCallback callback) throws RemoteException {
            ...
            try {
                ...
                callback.onValues(_hidl_reply.readInt32(), _hidl_reply.readInt32());
            } finally {
                _hidl_reply.release();
            }
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                case 1:
                    ...
                    getFeature(new GetFeatureCallback() {
                        @Override
                        public void onValues(int result, int feature) {
                            _hidl_reply.writeStatus(0);
                            _hidl_reply.writeInt32(result);
                            _hidl_reply.writeInt32(feature);
                            _hidl_reply.send();
                        }
                    });
                    return;
